function DozenDisplay(props) {
	...
	return (
		<div className='year-grid'>
			{weeksArr.map((weeks, weekIndex) => {
				const currWeek = yearIndex * 52 + weekIndex;
				const dotStyle =
					currWeek == finalWeek - 1
						? ' death'
						: currWeek < weekNum
						? ' solid'
						: currWeek == weekNum
				...
				return <div className={'dot ' + dotStyle} key={weekIndex} />;
			})}
		</div>
	);
}
...
export default function Calendar(props) {
	...
	return (
		<section>
			<p>
				<i>Each square of dots represents 52 weeks / 1 year of your life.</i>
			</p>
